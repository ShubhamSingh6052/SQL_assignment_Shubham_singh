...
Select Scientists.Name, Projects.Name, Projects.Hours from AssignedTo 
...
Select Projects.Name, AssignedTo.scientist from Projects Left join AssignedTo 
on Projects.Code = AssignedTo.Project
Where AssignedTo.Scientist is Null;
